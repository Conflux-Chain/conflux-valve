...
The artifactor can be used with [truffle-conflux-contract](https://github.com/trufflesuite/truffle/tree/develop/packages/truffle-conflux-contract), which provides features above and beyond `web3`:
...
Here, we'll generate a `.json` files given a JSON object like [truffle-conflux-contract-schema](https://github.com/trufflesuite/truffle/tree/develop/packages/truffle-conflux-contract-schema). This will give us a file which we can later `require` into other projects and contexts.
